...
if(!class_exists('CT_Plugin_Updater')) {
	class CT_Plugin_Updater {	
		...
		function plugin_api_call($defaults, $action, $args) {
			...
			if (!isset($args->slug) || ( isset($this->args['slug']) && $args->slug != $this->args['slug'] ) || ( isset($_GET['plugin']) && $args->slug != $_GET['plugin']) )
				return false;
