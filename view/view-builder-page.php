...
switch($action) {
	...
	case 'create' :
		...
		if(!is_wp_error($new_id)) {
			...
			$messages[] = '<div id="message" class="updated"><p>' . __('The ', 'framework') . '<strong>' . $template_name . '</strong>' . __(' tile template has been successfully created', 'framework') . '</p></div>';
		} else {
			$errors = '<ul>';
	...
	case 'update' :
		...
		$messages[] = '<div id="message" class="updated"><p>' . __('The ', 'framework') . '<strong>' . $template_name . '</strong>' . __(' tile template has been updated', 'framework') . '</p></div>';
		break;
...
<div class="wrap">
    ...
    Get Tile Builder Full Version and gain access to unlimited tiles, no messages and support.
    <br/>For as little as <span>$10 USD</span>.
    <br/><button onclick="location.href='http://crosstec.de/en/wordpress/tile-builder.html'">Get Tile Builder Full Version</button>
    </p>
	...
	<div id="page-builder-frame">
		...
		<div id="page-builder-column" class="metabox-holder <?php echo $disabled ?>">
			<div id="page-builder-archive" class="postbox">
				<h3 class="hndle"><span><?php _e('Available Elements', 'framework') ?></span><span id="removing-block"><?php _e('Deleting', 'framework') ?></span></h3>
				<div class="inside">
		...
		<div id="page-builder-fixed">
								...
								<div id="submitpost" class="submitbox">
									<div class="major-publishing-actions cf">
										...
										<div id="template-shortcode">
											<input type="text" readonly="readonly" value='[tile-template id="<?php echo $selected_template_id ?>"]' onclick="select()"/>
										</div>
						...
						<div id="aqpb-body">
							...
							<ul class="blocks cf" id="blocks-to-edit">
								...
								if($selected_template_id === 0) {
									...
									echo __('To create a custom tile template, give it a name above and click Create Template. Then choose blocks like text, widgets or tabs &amp; toggles from the left column to add to this template.
									<br/><br/>
									...
									<br/><br/>
									When you have finished building your custom tile template, make sure you click the Save Template button.', 'framework');
									echo '</p>';
			...
			<p style="float:left"><small>Tile Builder &copy; 2013 by <a href="http://crosstec.de">Crosstec.de</a></small></p>
			<p style="float:right"><small>Version <?php echo CTTB_VERSION ?></small></p>
