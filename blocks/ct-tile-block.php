<?php
/** A simple text block **/
class CT_Tile_Block extends CT_Block {
	...
	function __construct() {
		...
		//create the block
		parent::__construct('ct_tile_block', $block_options);
	}
